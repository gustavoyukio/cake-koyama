...
<?php echo $this->Form->create('Imovel'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Imovel'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Imovel.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Imovel.id'))); ?></li>
